        ...
        <div className="text-center max-w-md mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
            ...
            <p className="text-gray-700 mb-4">
              Optimist Farm is optimized for tablet and desktop experiences.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-2xl font-bold bg-gradient-to-r from-emerald-500 to-blue-500 dark:from-emerald-400 dark:to-blue-400 bg-clip-text text-transparent">
                  Optimist Farm
                </h1>
              </div>
                ...
                {books.map((book) => (
                  ...
                  >
                    <Link href={book.href} className="block">
                      <div className="bg-white/60 backdrop-blur-lg rounded-3xl p-6 shadow-xl border border-white/20 hover:bg-white/80 transition-all duration-300">
                        <div className="aspect-square rounded-2xl mb-4 overflow-hidden bg-gradient-to-br from-emerald-300 to-blue-300">
                          <img
                            src={book.image}
                            alt={book.title}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h4 className="text-xl font-bold text-gray-800 dark:text-white">Optimist Farm</h4>
                </div>
